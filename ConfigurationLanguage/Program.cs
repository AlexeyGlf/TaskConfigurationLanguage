...
namespace MyConfigConverter
{
    ...
    public static class Parser
    {
        ...
        //StringBuilder. Очень крутой оптимизированный класс который упращает взаимодействие со строками
        //Вместо создания новой строки и выделения под неё память, он добавляет значения из старой строки в новую, без копирования! (+ к производительности)
        ...
        private static object ParseValue(string value)
        {
            ...
            // Success - означает если нашло ли регулярное вырожение нашу строку
            if (binaryMatch.Success)
            {
                //Убираем первые 2 символа
        ...
        /// <summary>
        /// Данный метод представляет из себя получение значения по вводимому объекту. Если это строка то преобразует в ( Привет -> 'Привет' )
